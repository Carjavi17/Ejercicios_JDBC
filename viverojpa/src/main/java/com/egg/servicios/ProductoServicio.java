...
public class ProductoServicio {
    ...
    public void crearProducto(int cantidadStock, String codigoProducto, String descripcion,
            String dimensiones, String nombre, int precioProveedor, int precioVenta, String proveedor,
    ...
    */
    ...
    public void imprimirLista(List <Producto> listaRecibida)throws Exception{
        for (Producto unitariaProducto : listaRecibida){
            System.out.println(unitariaProducto.getCodigoProducto() + " - " + unitariaProducto.getNombre() + " - " + unitariaProducto.getCantidadEnStock());
        }
    }
